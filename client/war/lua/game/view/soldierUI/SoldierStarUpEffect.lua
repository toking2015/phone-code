local __this = SoldierStarUpEffect or {}
SoldierStarUpEffect = __this
local data = SoldierData.effStarData
...
--可升星
function __this:enableStarUpEffect( )
	...
	if self.effect2 == nil then
	    ...
	    self.effect2 = ArmatureSprite:addArmature(path1, 'sxk-tx-01', "SoldierUI", data.starLay.btnUp, 70, 70)
	    self.effect2:retain()
	end
end
...
function __this:initItemPercent( percent )
	...
	local effectBg = data.starLay.notUpLay.needBg
